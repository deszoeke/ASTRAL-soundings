%% Grid Radiosondes %%
% Merge U. Wyoming soundings with IMD soundings into a single file per
% station.
...
matdir = '/Volumes/cruise/SR1911/share/data/radiosonde/mat/';
...
%         pbin = [10-dp/2; dp/2+flipud(grd.p)];
    ...
    save(['../../data/radiosonde/gridded/' stations_mrg{istn} '_grd'],'grd');
...
%         pbin = [10-dp/2; dp/2+flipud(grd.p)];
    ...
    save(['../../data/radiosonde/gridded/' stns_xor_wyo{istn} '_grd'],'grd');
...
%         pbin = [10-dp/2; dp/2+flipud(grd.p)];
    ...
    save(['../../data/radiosonde/gridded/' stns_xor_imd{istn} '_grd'],'grd');
